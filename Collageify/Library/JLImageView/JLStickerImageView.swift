...
public class JLStickerImageView: UIImageView, UIGestureRecognizerDelegate {
    ...
    var objselection = ImageEDITViewcontroller()
    var objselectionStk = ImageEditActionVC()
...
extension JLStickerImageView {
    @objc func tapOutside() {
        if let _: JLStickerLabelView = currentlyEditingLabel {
            if objselection.viewTextEditor != nil {
                if isFromEditImageStk {
                    if objselectionStk.viewTextEditor.isHidden == false{
                        currentlyEditingLabel.hideEditingHandlers()
                        objselectionStk.viewTextEditor.isHidden = true
                    }else {
                        currentlyEditingLabel.showEditingHandles()
                        objselectionStk.viewTextEditor.isHidden = false
                    }
                } else {
                    if objselection.viewTextEditor.isHidden == false{
                        currentlyEditingLabel.hideEditingHandlers()
                        objselection.viewTextEditor.isHidden = true
                    }else {
                        currentlyEditingLabel.showEditingHandles()
                        objselection.viewTextEditor.isHidden = false
                    }
                }
            }
        }
