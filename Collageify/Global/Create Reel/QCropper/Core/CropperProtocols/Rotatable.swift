...
extension Rotatable where Self: CropperViewController {
    ...
    public func rotate90degrees(clockwise: Bool = true) {
        ...
        rotatingOverlay.layer.anchorPoint = CGPoint(x: rotatingCropBoxFrame.midX / rotatingOverlay.sizee.width,
                                                    y: rotatingCropBoxFrame.midY / rotatingOverlay.sizee.height)
