...
class Constants {
    ...
    static let clientID = "e9ff4228f3064df1acd0415c07a1eff8"
    static let clientSecret = "c0e12a3c08cd4326817389e6e09ded3c"
    ...
    static let redirectURI = "https://accounts.spotify.com/api/token"
    ...
    static let searchUrl = baseAPIURL + "/search?type=album,artist,playlist,track&include_external=audio"
}
